/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 904737024aa050fbb60baf63adacf826)
...
interface __BaseEnv_Env {
	...
	RECORDING_TRANSCRIPTION_WORKFLOW: Workflow<Parameters<import("./src/server").RecordingTranscriptionWorkflow['run']>[0]['payload']>;
	AUTUMN_PROD_SECRET_KEY?: string;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/server");
		durableNamespaces: "DocumentSession" | "OfficePdfConverter" | "WorkspaceFileProcessor" | "WorkspaceRoom";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "FIRECRAWL_API_URL" | "R2_BUCKET_NAME" | "BETTER_AUTH_URL" | "BETTER_AUTH_SECRET" | "GOOGLE_CLIENT_ID" | "GOOGLE_CLIENT_SECRET" | "FIRECRAWL_API_KEY" | "AI_GATEWAY_API_KEY" | "AUTUMN_SECRET_KEY" | "R2_ACCOUNT_ID" | "R2_ACCESS_KEY_ID" | "R2_SECRET_ACCESS_KEY" | "WORKSPACE_UPLOAD_TOKEN_SECRET" | "AUTUMN_PROD_SECRET_KEY">> {}
}
