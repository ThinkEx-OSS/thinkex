export function buildCodeExecuteToolDescription(): string {
  return [
    ...
    "Use for math, data analysis, charts (matplotlib/seaborn), simulations, or any computation.",
...
Use code_execute when: exact arithmetic or algebra verification, numerical simulation, statistical analysis, parsing/transforming structured data in Python, matplotlib/seaborn charts, or multi-step computation where mistakes are likely without execution.
...
Charts: only matplotlib and seaborn charts are auto-captured and displayed inline. Do NOT use plotly (its interactive HTML output is not supported). Always call plt.show() at the end of plotting code.
