...
const FileImpl: React.FC<FilePartProps> = ({ filename, data, mimeType }) => {
...
const FilePart = memo(FileImpl) as unknown as React.FC<FilePartProps> & {
...
FilePart.Root = FileRoot;
FilePart.Icon = FileIconDisplay;
FilePart.Name = FileName;
FilePart.Size = FileSize;
FilePart.Download = FileDownload;
