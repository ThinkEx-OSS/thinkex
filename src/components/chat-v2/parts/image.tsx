...
const ImageImpl: React.FC<ImagePartProps> = ({ image, filename }) => {
  return (
    <ImageRoot>
...
const ImagePart = memo(ImageImpl) as unknown as React.FC<ImagePartProps> & {
...
ImagePart.Root = ImageRoot;
ImagePart.Preview = ImagePreview;
ImagePart.Filename = ImageFilename;
ImagePart.Zoom = ImageZoom;
