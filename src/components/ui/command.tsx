...
const COMMAND_OMIT_PROPS = ["onSearchChange", "search"] as const;
...
function Command({
  ...
  const safeProps = Object.fromEntries(
    Object.entries(props).filter(([key]) => !COMMAND_OMIT_PROPS.includes(key as (typeof COMMAND_OMIT_PROPS)[number]))
  );
  return (
    <CommandPrimitive
      data-slot="command"
