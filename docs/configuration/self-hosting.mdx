...
- Provider keys for the features you enable: AI Gateway for AI chat and Firecrawl for web tools and document extraction. Analytics integrations are optional.
