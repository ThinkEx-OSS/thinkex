...
<CardGroup cols={2}>
  ...
  <Card title="Workspace items" icon="blocks" href="/concepts/items">
    Understand documents, files, and folders.
  </Card>
...
ThinkEx is a full-stack TypeScript app hosted on Cloudflare Workers. It uses PlanetScale Postgres through Hyperdrive for relational and canonical workspace state; Durable Objects for realtime workspace, document, AI, sandbox, and conversion coordination; R2 for binary workspace file storage; Workflows for extraction; Containers for code execution and file conversion; Workers AI, Images, Browser Run, and Email for product features.
